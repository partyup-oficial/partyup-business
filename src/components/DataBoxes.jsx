...
export default function DataBoxes() {
  return (
    <div className="flex justify-center gap-16 mb-12">
      <button className="flex flex-col items-center px-6 py-6 bg-black border-2 border-purple-900 w-44 bg-opacity-80 rounded-xl">
      ...
      <button className="flex flex-col items-center px-6 py-4 bg-black border-2 border-purple-900 w-44 bg-opacity-80 rounded-xl">
